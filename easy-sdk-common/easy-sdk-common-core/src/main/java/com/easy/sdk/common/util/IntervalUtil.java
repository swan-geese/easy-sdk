package com.easy.sdk.common.util;
 ...
 * 关于区间的工具<br>
 * <p>
 * https://blog.csdn.net/wenyichuan/article/details/122209572
 * </p>
 * 
 * @author 薛超
 * @since 2022年4月21日
...
public class IntervalUtil {
	...
	/**
	 * 将所有阀值区间转化为公式：如 [75,80) =》 date_value < 80 && date_value >= 75
	 * (125%,135%)U(70%,80%) =》 (date_value < 1.35 && date_value > 1.25) ||
	 * (date_value < 0.8 && date_value > 0.7)
	 * 
	 * @param date_value
	...
	/**
	 * 将整个阀值区间转化为公式：如 145) =》 date_value < 145 [75,80) =》 date_value < 80 &&
	 * date_value >= 75
	 * 
	 * @param date_value
	...
	/**
	 * 将半个阀值区间转化为公式：如 145) =》 date_value < 145 ≥80% =》 date_value >= 0.8 [130 =》
	 * date_value >= 130 <80% =》 date_value < 0.8
	 * 
