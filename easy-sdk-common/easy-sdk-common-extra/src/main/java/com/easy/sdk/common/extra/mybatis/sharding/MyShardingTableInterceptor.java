...
public class MyShardingTableInterceptor extends ShardingTableInnerInterceptor {

	@Getter
	private final Map<String, ShardingTableHandler> shardingTableHandlerMap;
	...
	protected String changeTable(SqlCommandType type, String sql, Object parameter) {
		...
		for (TableNameParser.SqlToken name : names) {
			...
			if (start != last) {
				...
				ShardingTableHandler handler = shardingTableHandlerMap.get(table);
				if (handler != null) {
					// 解析参数
