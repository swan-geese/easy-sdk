package com.easy.sdk.common.extra.mybatis.config;
...
import com.easy.sdk.common.extra.mybatis.plugin.MysqlTableNodesComplete;
import com.easy.sdk.common.extra.mybatis.plugin.SqliteTableNodesComplete;
import com.easy.sdk.common.extra.mybatis.sharding.DateMapperInterceptor;
import com.easy.sdk.common.extra.mybatis.sharding.MapperInvoker;
import com.easy.sdk.common.extra.mybatis.sharding.MyShardingTableInterceptor;
import com.easy.sdk.common.extra.mybatis.sharding.ShardingTableHandler;
...
public class SingleDataSourceConfig {
	...
	private Map<String, ShardingTableHandler> buildShardingTableHandlerMap(ShardingTableProperties prop) {
		...
		Map<String, ShardingTableProperties.ShardingTableRule> shardingTableMap = prop.getShardingTableRule();
		// 不启用分表功能
