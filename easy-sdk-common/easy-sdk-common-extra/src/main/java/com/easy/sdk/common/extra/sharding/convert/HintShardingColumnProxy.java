package com.easy.sdk.common.extra.sharding.convert;

import java.lang.reflect.Method;
import java.util.function.Function;

import com.easy.sdk.common.extra.sharding.annotation.ShardingColumn;
import com.easy.sdk.common.extra.sharding.annotation.ShardingExtraConfig;
import com.easy.sdk.common.extra.sharding.annotation.ShardingProperties;
...
public class HintShardingColumnProxy {
	...
	private String columnJson(Object[] args) {
		...
		if (json instanceof String) {
			ShardingModel model = JSONUtil.toBean(json.toString(), ShardingModel.ShardingJson.class);
