...
import com.easy.sdk.common.extra.mybatis.common.DateStrategyEnum;
import com.easy.sdk.common.extra.mybatis.config.ShardingTableProperties;
import com.easy.sdk.common.extra.mybatis.sharding.DateRangeModel;
import com.easy.sdk.common.extra.mybatis.sharding.ShardingEnum;
...
public interface WrapperUtil {
	...
	static <T> QueryWrapper<T> wrapBetweenDate(QueryWrapper<T> wrapper, Class<T> entityClass) {
		...
		String column = null;
		Map<String, ShardingTableProperties.ShardingTableRule> shardingTableRule = tableRuleProperties.getShardingTableRule();
		if (shardingTableRule.containsKey(tableName)) {
			ShardingTableProperties.ShardingTableRule rule = shardingTableRule.get(tableName);
	...
	static <T> ApplySql wrapApplySql(ApplySql applySql, String alias, Class<T> entityType) {
		ApplySql.ApplySqlSegment normalSegment = applySql.getNormalSegment();
