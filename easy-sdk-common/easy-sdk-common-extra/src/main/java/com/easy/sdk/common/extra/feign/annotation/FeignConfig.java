package com.easy.sdk.common.extra.feign.annotation;
...
import com.easy.sdk.common.extra.feign.encoder.FeignSpringFormEncoder;
import com.easy.sdk.common.extra.feign.proxy.FeignFallbackProxy;
...
@ConfigurationProperties(prefix = "easy.sdk.feign.request")
@Data
