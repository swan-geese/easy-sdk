package com.easy.sdk.common.extra.sharding.constant;
...
public interface ShardingConstant {
	...
	String SHARDING_PREFIX = "easy.sdk.sharding";

	/**
	 * 分片代理
	 */
	String SHARDING_PROXY = "@annotation(com.easy.sdk.common.extra.sharding.annotation.ShardingColumn)";
